...
{
    public partial class SprEmployeesJobPosSalary
    {
        ...
        public decimal? EmployeesRatio { get; set; }
        public decimal? CostMinute { get; set; }
        public decimal? CostNormal { get; set; }
        public decimal? CoefficientJobPos { get; set; }
