...
{
    public partial class DataServicesElplat
    {
        public DataServicesElplat()
        {
            DataServicesElplatInfos = new HashSet<DataServicesElplatInfo>();
        }
        ...
        public virtual ICollection<DataServicesElplatInfo> DataServicesElplatInfos { get; set; }
    }
}
